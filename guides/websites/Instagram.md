...
[Что за домены? Zapret?](./guides/Zapret.md) Там я расписал как установить Zapret и как добавить домена :)

[Что за айпишки? Hosts?](./guides/Hosts.md) Там я расписал как **найти файл hosts** и **как отредактировать сам файл** 🍔🍔
