...
## 📝 Метод 2.1: Редактирование файл Hosts

В терминале пишем sudo nano /etc/hosts (может отличаться) туда добавляем наши адреса и по такой-же схеме сохраняем и выходим.
